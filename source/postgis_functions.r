...
# You need a .pgpass file in order not to enter the password each time
# nano .pgpass
# *:*:indicators:postgres:password
# chmod 600 .pgpass

# you need to access /etc/odbc.ini
# add sth like
# [catchments]
# Description = Huff Catachments
